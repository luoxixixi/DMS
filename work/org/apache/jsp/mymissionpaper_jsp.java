 ...
 * Generated at: 2018-03-07 07:17:21 UTC
...
public final class mymissionpaper_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Papers papers = (Papers) request.getAttribute("papers");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"请输入毕业设计题目\" class=\"form-control\" value=\"");
      out.print(papers.getName());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<button id=\"btn\" class=\"btn btn-sm btn-primary pull-right m-t-n-xs\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tstyle=\"position: relative; top: -40px; left: -90px;\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tonclick=\"uppaper()\">\r\n");
      ...
      out.write("\t\t\t});\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\tfunction uppaper() {\r\n");
      out.write("\t\t\tvar t = $(\"#title\").val();\r\n");
      out.write("\t\t\tvar id = \"");
      out.print(papers.getPapersId());
      out.write("\";\r\n");
      out.write("\t\t\tif (t == \"\") {\r\n");
      out.write("\t\t\t\tlayer.msg('请输入', {\r\n");
      out.write("\t\t\t\t\ttime : 1000,\r\n");
      out.write("\t\t\t\t\ticon : 7,\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\treturn;\r\n");
